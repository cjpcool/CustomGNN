...
parser.add_argument('--lam_pw_emd', type=float, default=1., help='Number of epochs to train.')   #citeseer 5 10; cora 0.1 0.5;
...
parser.add_argument('--window_size', type=int, default=10)  # cora3,10; citeseer 456
